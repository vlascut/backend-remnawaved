...
RUN apk add --no-cache curl unzip ca-certificates \
    ...
    && curl -L https://remnawave.github.io/xray-monaco-editor/wasm_exec.js -o frontend_temp/wasm_exec.js \
    && curl -L https://remnawave.github.io/xray-monaco-editor/xray.schema.json -o frontend_temp/xray.schema.json \
    && curl -L https://remnawave.github.io/xray-monaco-editor/main.wasm -o frontend_temp/main.wasm
