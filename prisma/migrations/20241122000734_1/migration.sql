/*
  ...
  - A unique constraint covering the columns `[node_uuid,user_uuid,created_at]` on the table `nodes_user_usage_history` will be added. If there are existing duplicate values, this will fail.
