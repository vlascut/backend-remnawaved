...
-- AlterTable
ALTER TABLE "users" ADD COLUMN     "last_connected_node_uuid" UUID,
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_last_connected_node_uuid_fkey" FOREIGN KEY ("last_connected_node_uuid") REFERENCES "nodes"("uuid") ON DELETE SET NULL ON UPDATE CASCADE;
