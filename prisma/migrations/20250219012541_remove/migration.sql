...
-- UpdateTable
UPDATE "users" SET "traffic_limit_strategy" = 'MONTH' WHERE "traffic_limit_strategy" = 'CALENDAR_MONTH';

-- UpdateTable
UPDATE "users" SET "traffic_limit_strategy" = 'MONTH' WHERE "traffic_limit_strategy" = 'YEAR';