/*
  ...
  - You are about to drop the column `traffic_reset_at` on the `users` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "user_usage_history" ALTER COLUMN "reset_at" SET DEFAULT now();

-- AlterTable
ALTER TABLE "users" DROP COLUMN "traffic_reset_at",
ADD COLUMN     "last_traffic_reset_at" TIMESTAMP(3),
