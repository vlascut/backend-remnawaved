/*
  ...
  - You are about to drop the column `token_description` on the `api_tokens` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "api_tokens" DROP COLUMN "token_description",
