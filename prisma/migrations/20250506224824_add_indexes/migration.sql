...
-- CreateIndex
CREATE INDEX "active_user_inbounds_user_uuid_idx" ON "active_user_inbounds"("user_uuid");

-- CreateIndex
CREATE INDEX "nodes_usage_history_node_uuid_created_at_idx" ON "nodes_usage_history"("node_uuid", "created_at" DESC);

-- CreateIndex
CREATE INDEX "nodes_user_usage_history_node_uuid_created_at_idx" ON "nodes_user_usage_history"("node_uuid", "created_at" DESC);
